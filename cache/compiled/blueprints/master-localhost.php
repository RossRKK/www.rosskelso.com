...
return [
    ...
    'timestamp' => 1739468430,
    'checksum' => '6509633f6c55eb6191946320d70a2e49',
    'files' => [
        ...
        'user/themes' => [
            ...
            'themes/darkquark' => [
                'file' => 'user/themes/darkquark/blueprints.yaml',
                'modified' => 1739465333
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.canvas.style' => [
                'type' => 'tab',
                'name' => 'themes.canvas.style',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.style.color',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.palette' => [
                'type' => 'radio',
                ...
                'name' => 'themes.canvas.style.color.palette',
                'validation' => 'loose'
            ],
            'themes.canvas.column_title' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.column_title',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.style.color.custom',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light' => [
                'type' => '_parent',
                'name' => 'themes.canvas.style.color.custom.light',
                'form_field' => false
            ],
            'themes.canvas.style.color.custom.light.bg' => [
                'type' => 'colorpicker',
                'label' => 'Background color',
                'default' => '#fffff',
                'name' => 'themes.canvas.style.color.custom.light.bg',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.accent_bg' => [
                'type' => 'colorpicker',
                'label' => 'Background accent',
                'default' => '#f5f7ff',
                'name' => 'themes.canvas.style.color.custom.light.accent_bg',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.text' => [
                'type' => 'colorpicker',
                'label' => 'Text color',
                'default' => '#212121',
                'name' => 'themes.canvas.style.color.custom.light.text',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.text_light' => [
                'type' => 'colorpicker',
                'label' => 'Light text',
                'default' => '#585858',
                'name' => 'themes.canvas.style.color.custom.light.text_light',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.border' => [
                'type' => 'colorpicker',
                'label' => 'Borders',
                'default' => '#d8dae1',
                'name' => 'themes.canvas.style.color.custom.light.border',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.accent' => [
                'type' => 'colorpicker',
                'label' => 'Accent color',
                'default' => '#004d40',
                'name' => 'themes.canvas.style.color.custom.light.accent',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.code' => [
                'type' => 'colorpicker',
                'label' => 'Code snippets',
                'default' => '#795548',
                'name' => 'themes.canvas.style.color.custom.light.code',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.preformatted' => [
                'type' => 'colorpicker',
                'label' => 'Preformatted text',
                'default' => '#444444',
                'name' => 'themes.canvas.style.color.custom.light.preformatted',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.light.disabled' => [
                'type' => 'colorpicker',
                'label' => 'Disabled text',
                'default' => '#efefef',
                'name' => 'themes.canvas.style.color.custom.light.disabled',
                'validation' => 'loose'
            ],
            'themes.canvas.light_column' => [
                'type' => 'column',
                'name' => 'themes.canvas.light_column',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark' => [
                'type' => '_parent',
                'name' => 'themes.canvas.style.color.custom.dark',
                'form_field' => false
            ],
            'themes.canvas.style.color.custom.dark.bg' => [
                'type' => 'colorpicker',
                'label' => 'Background color',
                'default' => '#212121',
                'name' => 'themes.canvas.style.color.custom.dark.bg',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.accent_bg' => [
                'type' => 'colorpicker',
                'label' => 'Background accent',
                'default' => '#2b2b2b',
                'name' => 'themes.canvas.style.color.custom.dark.accent_bg',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.text' => [
                'type' => 'colorpicker',
                'label' => 'Text color',
                'default' => '#dcdcdc',
                'name' => 'themes.canvas.style.color.custom.dark.text',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.text_light' => [
                'type' => 'colorpicker',
                'label' => 'Light text',
                'default' => '#ababab',
                'name' => 'themes.canvas.style.color.custom.dark.text_light',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.border' => [
                'type' => 'colorpicker',
                'label' => 'Borders',
                'default' => '#666',
                'name' => 'themes.canvas.style.color.custom.dark.border',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.accent' => [
                'type' => 'colorpicker',
                'label' => 'Accent color',
                'default' => '#00bcd4',
                'name' => 'themes.canvas.style.color.custom.dark.accent',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.code' => [
                'type' => 'colorpicker',
                'label' => 'Code snippets',
                'default' => '#ea80fc',
                'name' => 'themes.canvas.style.color.custom.dark.code',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.preformatted' => [
                'type' => 'colorpicker',
                'label' => 'Preformatted text',
                'default' => '#cccccc',
                'name' => 'themes.canvas.style.color.custom.dark.preformatted',
                'validation' => 'loose'
            ],
            'themes.canvas.style.color.custom.dark.disabled' => [
                'type' => 'colorpicker',
                'label' => 'Disabled text',
                'default' => '#111111',
                'name' => 'themes.canvas.style.color.custom.dark.disabled',
                'validation' => 'loose'
            ],
            'themes.canvas.dark_column' => [
                'name' => 'themes.canvas.dark_column',
                'type' => 'column',
                'validation' => 'loose'
            ],
            'themes.canvas.columns' => [
                'type' => 'columns',
                'name' => 'themes.canvas.columns',
                'validation' => 'loose'
            ],
            'themes.canvas.style.custom' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.style.custom',
                'validation' => 'loose'
            ],
            'themes.canvas.style.custom.css' => [
                'type' => 'textarea',
                'label' => 'Custom CSS',
                'size' => 'large',
                'name' => 'themes.canvas.style.custom.css',
                'validation' => 'loose'
            ],
            'themes.canvas.custom_css' => [
                'type' => 'column',
                'name' => 'themes.canvas.custom_css',
                'validation' => 'loose'
            ],
            'themes.canvas.style.custom.js' => [
                'type' => 'textarea',
                'label' => 'Custom JS',
                'size' => 'large',
                'name' => 'themes.canvas.style.custom.js',
                'validation' => 'loose'
            ],
            'themes.canvas.custom_js' => [
                'type' => 'column',
                'name' => 'themes.canvas.custom_js',
                'validation' => 'loose'
            ],
            'themes.canvas.partials' => [
                'type' => '_parent',
                'name' => 'themes.canvas.partials',
                'form_field' => false
            ],
            'themes.canvas.partials.navigation' => [
                'type' => '_parent',
                'name' => 'themes.canvas.partials.navigation',
                'form_field' => false
            ],
            'themes.canvas.partials.navigation.where' => [
                'type' => 'radio',
                ...
                'default' => 'header',
                'name' => 'themes.canvas.partials.navigation.where',
                'validation' => 'loose'
            ],
            'themes.canvas.navigation_options' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.navigation_options',
                'validation' => 'loose'
            ],
            'themes.canvas.partials.footer' => [
                'type' => '_parent',
                'name' => 'themes.canvas.partials.footer',
                'form_field' => false
            ],
            'themes.canvas.partials.footer.attribution' => [
                'type' => '_parent',
                'name' => 'themes.canvas.partials.footer.attribution',
                'form_field' => false
            ],
            'themes.canvas.partials.footer.attribution.content' => [
                'type' => 'text',
                'autofocus' => true,
                'label' => 'Custom attribution',
                'markdown' => true,
                'name' => 'themes.canvas.partials.footer.attribution.content',
                'validation' => 'loose'
            ],
            'themes.canvas.partials.footer.theme_attribution' => [
                'type' => '_parent',
                'name' => 'themes.canvas.partials.footer.theme_attribution',
                'form_field' => false
            ],
            'themes.canvas.partials.footer.theme_attribution.toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.canvas.partials.footer.theme_attribution.toggle',
                'validation' => 'loose'
            ],
            'themes.canvas.attribution_options' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.attribution_options',
                'validation' => 'loose'
            ],
            'themes.canvas.template_options_description' => [
                'type' => 'display',
                'label' => 'How it works',
                'content' => 'Some templates have layout settings. Change their settings below to define their defaults.',
                'name' => 'themes.canvas.template_options_description',
                'validation' => 'loose'
            ],
            'themes.canvas.partials.metadata' => [
                'type' => '_parent',
                'name' => 'themes.canvas.partials.metadata',
                'form_field' => false
            ],
            'themes.canvas.partials.metadata.where' => [
                'type' => 'radio',
                ...
                'default' => 'header',
                'name' => 'themes.canvas.partials.metadata.where',
                'validation' => 'loose'
            ],
            'themes.canvas.template_options' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.template_options',
                'validation' => 'loose'
            ],
            'themes.canvas.layout' => [
                'type' => 'tab',
                'name' => 'themes.canvas.layout',
                'validation' => 'loose'
            ],
            'themes.canvas.media' => [
                'type' => 'tab',
                'name' => 'themes.canvas.media',
                'validation' => 'loose'
            ],
            'themes.canvas.media.favicon' => [
                'type' => '_parent',
                'name' => 'themes.canvas.media.favicon',
                'form_field' => false
            ],
            'themes.canvas.media.favicon.file' => [
                'type' => 'file',
                ...
                'name' => 'themes.canvas.media.favicon.file',
                'validation' => 'loose'
            ],
            'themes.canvas.custom_favicon' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.custom_favicon',
                'validation' => 'loose'
            ],
            'themes.canvas.media.featured_image' => [
                'type' => '_parent',
                'name' => 'themes.canvas.media.featured_image',
                'form_field' => false
            ],
            'themes.canvas.media.featured_image.file' => [
                'type' => 'file',
                ...
                'name' => 'themes.canvas.media.featured_image.file',
                'validation' => 'loose'
            ],
            'themes.canvas.custom_featured_image' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.canvas.custom_featured_image',
                'validation' => 'loose'
            ],
            'themes.canvas.tabs' => [
                'type' => 'tabs',
                'active' => 0,
                'name' => 'themes.canvas.tabs',
                'validation' => 'loose'
            ],
            'themes.darkquark' => [
                'type' => '_root',
            ...
            'themes.darkquark.production-mode' => [
                'type' => 'toggle',
                'label' => 'Production mode',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.darkquark.production-mode',
                'validation' => 'loose'
            ],
            'themes.darkquark.grid-size' => [
                'type' => 'select',
                'label' => 'Grid size',
                'size' => 'small',
                'options' => [
                ...
                'name' => 'themes.darkquark.grid-size',
                'validation' => 'loose'
            ],
            'themes.darkquark.header_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.darkquark.header_section',
                'validation' => 'loose'
            ],
            'themes.darkquark.custom_logo' => [
                'type' => 'file',
                'label' => 'Custom Logo',
                'size' => 'large',
                'destination' => 'theme://images/logo',
                ...
                'name' => 'themes.darkquark.custom_logo',
                'validation' => 'loose'
            ],
            'themes.darkquark.custom_logo_mobile' => [
                'type' => 'file',
                'label' => 'Mobile Custom Logo',
                'size' => 'large',
                'destination' => 'theme://images/logo',
                ...
                'name' => 'themes.darkquark.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.darkquark.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.darkquark.header-fixed',
                'validation' => 'loose'
            ],
            'themes.darkquark.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.darkquark.header-animated',
                'validation' => 'loose'
            ],
            'themes.darkquark.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.darkquark.header-dark',
                'validation' => 'loose'
            ],
            'themes.darkquark.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.darkquark.header-transparent',
                'validation' => 'loose'
            ],
            'themes.darkquark.footer_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.darkquark.footer_section',
                'validation' => 'loose'
            ],
            'themes.darkquark.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.darkquark.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.darkquark.blog_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.darkquark.blog_section',
                'validation' => 'loose'
            ],
            'themes.darkquark.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.darkquark.blog-page',
                'validation' => 'loose'
            ],
            'themes.darkquark.spectre_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.darkquark.spectre_section',
                'validation' => 'loose'
            ],
            'themes.darkquark.spectre' => [
                'type' => '_parent',
                'name' => 'themes.darkquark.spectre',
                'form_field' => false
            ],
            'themes.darkquark.spectre.exp' => [
                'type' => 'toggle',
                'label' => 'Experimentals CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.darkquark.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.darkquark.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.darkquark.spectre.icons',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                ...
                'canvas' => [
                    'tabs' => 'themes.canvas.tabs',
                    'style' => [
                        'color' => [
                            'palette' => 'themes.canvas.style.color.palette',
                            'custom' => [
                                'light' => [
                                    'bg' => 'themes.canvas.style.color.custom.light.bg',
                                    'accent_bg' => 'themes.canvas.style.color.custom.light.accent_bg',
                                    'text' => 'themes.canvas.style.color.custom.light.text',
                                    'text_light' => 'themes.canvas.style.color.custom.light.text_light',
                                    'border' => 'themes.canvas.style.color.custom.light.border',
                                    'accent' => 'themes.canvas.style.color.custom.light.accent',
                                    'code' => 'themes.canvas.style.color.custom.light.code',
                                    'preformatted' => 'themes.canvas.style.color.custom.light.preformatted',
                                    'disabled' => 'themes.canvas.style.color.custom.light.disabled'
                                ],
                                'dark' => [
                                    'bg' => 'themes.canvas.style.color.custom.dark.bg',
                                    'accent_bg' => 'themes.canvas.style.color.custom.dark.accent_bg',
                                    'text' => 'themes.canvas.style.color.custom.dark.text',
                                    'text_light' => 'themes.canvas.style.color.custom.dark.text_light',
                                    'border' => 'themes.canvas.style.color.custom.dark.border',
                                    'accent' => 'themes.canvas.style.color.custom.dark.accent',
                                    'code' => 'themes.canvas.style.color.custom.dark.code',
                                    'preformatted' => 'themes.canvas.style.color.custom.dark.preformatted',
                                    'disabled' => 'themes.canvas.style.color.custom.dark.disabled'
                                ]
                            ]
                        ],
                        'custom' => [
                            'css' => 'themes.canvas.style.custom.css',
                            'js' => 'themes.canvas.style.custom.js'
                        ]
                    ],
                    'columns' => 'themes.canvas.columns',
                    'light_column' => 'themes.canvas.light_column',
                    'column_title' => 'themes.canvas.column_title',
                    'dark_column' => 'themes.canvas.dark_column',
                    'custom_css' => 'themes.canvas.custom_css',
                    'custom_js' => 'themes.canvas.custom_js',
                    'layout' => 'themes.canvas.layout',
                    'navigation_options' => 'themes.canvas.navigation_options',
                    'partials' => [
                        'navigation' => [
                            'where' => 'themes.canvas.partials.navigation.where'
                        ],
                        'footer' => [
                            'attribution' => [
                                'content' => 'themes.canvas.partials.footer.attribution.content'
                            ],
                            'theme_attribution' => [
                                'toggle' => 'themes.canvas.partials.footer.theme_attribution.toggle'
                            ]
                        ],
                        'metadata' => [
                            'where' => 'themes.canvas.partials.metadata.where'
                        ]
                    ],
                    'attribution_options' => 'themes.canvas.attribution_options',
                    'template_options' => 'themes.canvas.template_options',
                    'template_options_description' => 'themes.canvas.template_options_description',
                    'media' => [
                        'favicon' => [
                            'file' => 'themes.canvas.media.favicon.file'
                        ],
                        'featured_image' => [
                            'file' => 'themes.canvas.media.featured_image.file'
                        ]
                    ],
                    'custom_favicon' => 'themes.canvas.custom_favicon',
                    'custom_featured_image' => 'themes.canvas.custom_featured_image'
                ],
                'darkquark' => [
                    'production-mode' => 'themes.darkquark.production-mode',
                    'grid-size' => 'themes.darkquark.grid-size',
                    'header_section' => 'themes.darkquark.header_section',
                    'custom_logo' => 'themes.darkquark.custom_logo',
                    'custom_logo_mobile' => 'themes.darkquark.custom_logo_mobile',
                    'header-fixed' => 'themes.darkquark.header-fixed',
                    'header-animated' => 'themes.darkquark.header-animated',
                    'header-dark' => 'themes.darkquark.header-dark',
                    'header-transparent' => 'themes.darkquark.header-transparent',
                    'footer_section' => 'themes.darkquark.footer_section',
                    'sticky-footer' => 'themes.darkquark.sticky-footer',
                    'blog_section' => 'themes.darkquark.blog_section',
                    'blog-page' => 'themes.darkquark.blog-page',
                    'spectre_section' => 'themes.darkquark.spectre_section',
                    'spectre' => [
                        'exp' => 'themes.darkquark.spectre.exp',
                        'icons' => 'themes.darkquark.spectre.icons'
                    ]
                ]
            ]
        ],
